    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CustomerDemographicsCustomerTypeID = table.Column<string>(type: "nvarchar(10)", nullable: false),
                    CustomersCustomerID = table.Column<string>(type: "nvarchar(5)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CustomerCustomerDemo", x => new { x.CustomerDemographicsCustomerTypeID, x.CustomersCustomerID });
                    table.ForeignKey(
                        name: "FK_CustomerCustomerDemo_CustomerDemographics_CustomerDemographicsCustomerTypeID",
                        column: x => x.CustomerDemographicsCustomerTypeID,
                        principalTable: "CustomerDemographics",
                        principalColumn: "CustomerTypeID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CustomerCustomerDemo_Customers_CustomersCustomerID",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Freight = table.Column<decimal>(type: "money", precision: 19, scale: 4, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UnitPrice = table.Column<decimal>(type: "money", precision: 19, scale: 4, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EmployeeTerritories", x => new { x.EmployeesEmployeeID, x.TerritoriesTerritoryID });
                    table.ForeignKey(
                        name: "FK_EmployeeTerritories_Employees_EmployeesEmployeeID",
                        column: x => x.EmployeesEmployeeID,
                        principalTable: "Employees",
                        principalColumn: "EmployeeID",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EmployeeTerritories_Territories_TerritoriesTerritoryID",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    OrderID = table.Column<int>(type: "int", nullable: false),
                    ProductID = table.Column<int>(type: "int", nullable: false),
                    UnitPrice = table.Column<decimal>(type: "money", precision: 19, scale: 4, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CustomerCustomerDemo_CustomersCustomerID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmployeeTerritories_TerritoriesTerritoryID",
